...
namespace Hos.ScheduleMaster.Core.Models
{
    public class SmDbContext : DbContext
    {
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.FixColumnsDataType<ScheduleGroupEntity>();
			modelBuilder.FixColumnsDataType<ScheduleGroupRelationEntity>();
		...
		public virtual DbSet<ScheduleGroupRelationEntity> ScheduleGroupRelations { get; set; }
